            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2 class="h4 font-weight-bold text-dark mb-1">
                        <i class="fas fa-calendar-alt text-primary me-2"></i>Daftar Pertemuan — {{ $subject->name }}
                    </h2>
                    <p class="text-muted small mb-0">Kelas: <strong>{{ $class->name }}</strong> ({{ $class->students_count }} Siswa)</p>
                </div>
