            ...
            <form method="POST" action="{{ route('tatausaha.teachers.update', $teacher) }}">
                ...
                <div class="mb-4">
                    ...
                    <div class="position-relative">
                        <x-text-input id="tu_teacher_password" class="form-control pe-5" type="password" name="password" placeholder="Kosongkan jika tidak diubah" />
                        <button type="button" class="btn btn-link text-muted position-absolute end-0 top-50 translate-middle-y me-2 text-decoration-none shadow-none" onclick="togglePasswordVisibility('tu_teacher_password', this)">
                            <i class="far fa-eye"></i>
                        </button>
                    </div>
                    <x-password-strength-meter inputId="tu_teacher_password" />
                </div>
